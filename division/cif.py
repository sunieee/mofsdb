...
class Cif:
    ...
    def generate_cif(self, folder):
        ...
        for i, cif in enumerate(cifs):
            ...
            lines = [cif.title] + cif.file_info + ['loop_'] + cif.symmetry_info \
                     + ['loop_'] + cif.atoms_info

            # print(cif.file_info, cif.symmetry_info, cif.atoms_info)
